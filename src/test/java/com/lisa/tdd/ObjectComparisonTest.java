...
public class ObjectComparisonTest {
     ...
     public void testObjectIdentity() throws Exception
    {
        ...
        Movies movie1 = assertionService.getMovies("Hunger Games", "5");
        Movies movie2 = assertionService.getMovies("Bolt", "5");
        
        Assert.assertNotSame(movie1, movie2, "Asserting object identity");
    }
}
